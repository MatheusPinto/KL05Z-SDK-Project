...
/*
 * It is possible to change gcc stack and heap size by passing the following parameter
 * to linker:
 *
 * -Xlinker -defsym=__heap_size__=0x0 -Xlinker -defsym=__stack_size__=0x80
 *
 * */

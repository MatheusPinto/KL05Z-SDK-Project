...
int main()
{
	...
	PORT_SetMux( PORTA, 12, PORT_MUX_AS_GPIO );
	PORT_SetMux( PORTB, 6, PORT_MUX_AS_GPIO );
	PORT_SetMux( PORTB, 7, PORT_MUX_AS_GPIO );
	PORT_SetMux( PORTB, 10, PORT_MUX_AS_GPIO );
	PORT_SetMux( PORTB, 11, PORT_MUX_AS_GPIO );
